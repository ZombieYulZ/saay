...
def get_pie_chart (entered_site):
    ...
    if entered_site == 'ALL':
        ...
        fig = px.pie(filtered_df, values='class count', names='class', title=f'Total Success Launch for Site {entered_site}')
...
def get_scatter_chart (entered_site, payload_range):
    low=float(payload_range [0])
    high=float(payload_range[1])
